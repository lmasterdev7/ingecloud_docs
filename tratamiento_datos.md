# $${\color{blue}\text{Política de Privacidad y Tratamiento de Datos}}$$

Santiago de Cali, 1 de enero del 2026 

## $${\color{blue}\text{1. Introducción}}$$

Ingecon Group SAS, con domicilio en Cali, Colombia, es responsable del tratamiento de los datos personales gestionados a través de su plataforma tecnológica Ingecloud. 

La presente Política de Privacidad describe cómo recopilamos, utilizamos, almacenamos, protegemos y tratamos los datos personales conforme a la Ley 1581 de 2012 y demás normas complementarias en Colombia. 

El uso de la plataforma implica la aceptación de los términos aquí establecidos. 

Responsable del tratamiento: **900397677 INGECON GROUP SAS**

Domicilio: **CL 47BN # 3EN – 26 Cali - Colombia**

Correo de contacto para temas de privacidad: **soporte@ingecongroup.com**

## $${\color{blue}\text{2. Definiciones relevantes}}$$
**Dato personal:** Información vinculada o que pueda asociarse a una persona natural. 
**Dato sensible:** Información que afecta la intimidad del titular o cuyo uso indebido puede generar discriminación (ej. biometría). 
...
## $${\color{blue}\text{3. Datos personales que tratamos}}$$
A través de Ingecloud se pueden tratar las siguientes categorías de datos: 
-  Nombres y apellidos 
-  Número de identificación (cédula) 
-  Información laboral 
-  Registros de asistencia 
-  Datos biométricos (cuando el cliente los habilita) 
-  Información de autenticación (usuario y contraseña en formato cifrado) 

## $${\color{blue}\text{4. Finalidades del tratamiento}}$$
Los datos personales son tratados exclusivamente para: 
-  Gestión de asistencia y control horario. 
-  Administración de usuarios dentro de la plataforma. 
...
## $${\color{blue}\text{5. Base legal del tratamiento}}$$
...
## $${\color{blue}\text{6. Encargado vs responsable}}$$
...
## $${\color{blue}\text{7. Medidas de Seguridad}}$$
...
## $${\color{blue}\text{8. Almacenamiento y Transferencias Internacionales}}$$
...
## $${\color{blue}\text{9. Retención de Datos}}$$
...
## $${\color{blue}\text{10. Derechos de los Titulares}}$$
...
## $${\color{blue}\text{11. Procedimiento para Ejercer Derechos}}$$
...
## $${\color{blue}\text{12. Cookies y Tecnologías Similares}}$$
...
## $${\color{blue}\text{13. Modificaciones a la Política}}$$
