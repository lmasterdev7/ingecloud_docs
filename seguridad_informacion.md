...
Se identifican proveedores que cumplen funciones esenciales para la 	operación de la plataforma, tales como: 
...
Antes de utilizar un proveedor tecnológico se revisan aspectos como: 
...
Los proveedores se clasifican según su nivel de impacto en la operación del servicio: 
...
La plataforma Ingecloud utiliza proveedores tecnológicos reconocidos en la industria cloud: 

Infraestructura cloud 

La infraestructura principal se encuentra alojada en Hetzner, 		proveedor internacional de servicios de nube que ofrece controles de 	seguridad de red, aislamiento de infraestructura y mecanismos de 	protección contra amenazas. 

Protección de red y seguridad 

La protección perimetral y el filtrado de tráfico se gestionan 		mediante Cloudflare, incluyendo: 
...
Los respaldos adicionales de infraestructura y datos se almacenan en 	servicios cloud externos como DigitalOcean, con el objetivo de 		mantener redundancia y resiliencia ante fallas del proveedor principal. 

ShapeRevisión periódica de proveedores 

Los proveedores tecnológicos son revisados periódicamente considerando: 
...
ShapeEstrategias de mitigación de riesgos 

Para reducir la dependencia de proveedores individuales, la organización implementa medidas como: 
...
La gestión de riesgos de proveedores es responsabilidad del área de tecnología de Ingecon Group SAS, encargada de: 
